...
# merge blastx results

# Note: the original file was here: https://github.com/HuffordLab/NAM-genomes/blob/master/gene-prediction/scripts-evidence/BlastXMLmerge.py
