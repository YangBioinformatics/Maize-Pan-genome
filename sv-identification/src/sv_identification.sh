...
# cutesv, for NanoPore data, such as CIMBL70
...
rm -rf CIMBL70
# cutesv, for NanoPore data, such as CIMBL55
...
rm -r CIMBL55
# for SyRi
nucmer --maxmatch -c 500 -b 500 -l 200 -g 1000 -p syri_out_genome/B73v5_CIMBL70 /data/genome.2021/B73v5/genome.fa /data/genome/CIMBL70/genome.fa
...
/data/genome.2021/B73v5/genome.fa -q /data/genome.2021/CIMBL70/genome.fa --prefix B73v5_CIMBL70. --lf B73v5_CIMBL70.syri.log
# for smartie-sv
# using CIMBL70 contigs as input
